...
final class TapBarController: UITabBarController {
    ...
    private func configure() {
        ...
        overviewNavigation.tabBarItem = UITabBarItem(title: Resouces.Strings.TapBar.overview,
                                                     image: Resouces.Images.TapBar.overview,
                                                     tag: Tabs.overview.rawValue)
        sessionNavigation.tabBarItem = UITabBarItem(title: Resouces.Strings.TapBar.session,
                                                     image: Resouces.Images.TapBar.session,
                                                     tag: Tabs.session.rawValue)
        progressNavigation.tabBarItem = UITabBarItem(title: Resouces.Strings.TapBar.progress,
                                                     image: Resouces.Images.TapBar.progress,
                                                     tag: Tabs.progress.rawValue)
        settingsNavigation.tabBarItem = UITabBarItem(title: Resouces.Strings.TapBar.settings,
                                                     image: Resouces.Images.TapBar.settings,
